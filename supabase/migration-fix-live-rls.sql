...
drop policy if exists "activity_public_read_v2" on public.activity;
...
drop policy if exists "logs_public_read" on public.student_logs;
drop policy if exists "logs_public_read_v2" on public.student_logs;
drop policy if exists "student_logs_public_read" on public.student_logs;
drop policy if exists "logs_admin_read" on public.student_logs;
drop policy if exists "logs_own_read" on public.student_logs;
