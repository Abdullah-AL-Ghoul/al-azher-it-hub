...
export default function OverviewPanel({
  ...
  return (
    <>
      ...
      <motion.div initial={prefersReduced ? {} : { opacity: 0, y: 20 }} animate={prefersReduced ? {} : { opacity: 1, y: 0 }} transition={{ delay: 0.7 }} className="glass rounded-2xl p-5 border border-white/10 mt-6">
        <div className="flex items-center justify-between mb-4">
      ...
      <motion.div initial={prefersReduced ? {} : { opacity: 0, y: 20 }} animate={prefersReduced ? {} : { opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="glass rounded-2xl p-5 border border-white/10 mt-6">
        <div className="flex items-center justify-between mb-4">
