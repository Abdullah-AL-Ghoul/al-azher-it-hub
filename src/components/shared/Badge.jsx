export default function Badge({ children, tone = 'default', className = '' }) {
 const tones = {
  default: 'bg-black/5 dark:bg-white/5 border-black/8 dark:border-white/10 text-slate-600 dark:text-white/60',
  accent: 'bg-royal-500/10 dark:bg-cyan-500/10 border-royal-500/20 dark:border-cyan-500/20 text-royal-500 dark:text-cyan-400',
