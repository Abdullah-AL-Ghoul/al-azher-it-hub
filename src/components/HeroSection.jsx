 ...
 return (
  <div className="relative min-h-[calc(100vh-5rem)] flex items-center justify-center overflow-hidden bg-spatial-page">
   <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
    <div className="absolute top-20 left-10 w-64 h-64 bg-royal-500/20 rounded-full blur-2xl"></div>
    <div className="absolute bottom-20 right-10 w-80 h-80 bg-cyan-400/15 rounded-full blur-2xl"></div>
   </div>

   <div className="absolute inset-0">
    <div className="absolute top-1/3 right-[25%] w-3 h-3 bg-cyan-400/30 rounded-full"></div>
    <div className="absolute bottom-1/3 left-[33%] w-1.5 h-1.5 bg-violet-400/30 rounded-full"></div>
    <div className="absolute top-2/3 right-[33%] w-2 h-2 bg-royal-500/30 rounded-full"></div>
    <div className="absolute bottom-[20%] right-[15%] w-2.5 h-2.5 bg-cyan-400/20 rounded-full"></div>
   </div>
